...
public class ChooseFunctionActivity extends AppCompatActivity {
    ...
    public void jumpToMyActivity(View view){
        startActivity(new Intent(this, MyActivity.class));
    }

    public void jumpToMyActivity2(View view) {
        startActivity(new Intent(this, MyActivity2.class));

    }

    public void jumptoMyregisterActivity(View view) {
        startActivity(new Intent(this, MyRegisterActivity.class));
    }

    public void jumptoSettingActivity(View view) {
