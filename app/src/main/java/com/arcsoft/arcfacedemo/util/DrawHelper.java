...
public class DrawHelper {
    ...
    public void draw(FaceRectView faceRectView, List<DrawInfo> drawInfoList) {
        ...
        for (DrawInfo drawInfo : drawInfoList) {
            realrect = adjustRect(drawInfo.getRect(), previewWidth, previewHeight, canvasWidth, canvasHeight, cameraDisplayOrientation, cameraId,
                    isMirror, false, false);
            drawInfo.setRect(realrect);
        }
